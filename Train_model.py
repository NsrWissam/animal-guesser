...
#
# train_models([model1, model2, model3, model4, model5], X, y)
#
...
#
# pickle.dump(model1, open("model1_KNC.p", "wb"))
# pickle.dump(model2, open("model2_RFC.p", "wb"))
# pickle.dump(model3, open("model3_LGC.p", "wb"))
# pickle.dump(model4, open("model4_LSVC.p", "wb"))
# pickle.dump(model5, open("model5_MLPC.p", "wb"))

pickle.dump(create_name_dict(library_map_wiki), open("name_dict.p", "wb"))
vectorizer = TfidfVectorizer()
vectorizer = vectorizer.fit(library_map_wiki.values())
pickle.dump(vectorizer, open("tfidvector.p", "wb"))
